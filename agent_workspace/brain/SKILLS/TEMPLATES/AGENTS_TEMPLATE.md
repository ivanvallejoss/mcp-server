# 🧠 MASTER ORCHESTRATION PLAN (ROOT)
...
* **Logging:** After completing a task, you MUST append a summary to `./PROJECT_STATE.md` following the format:
    ```
    - [DATE] [AGENT_TYPE]: [INSTRUCTION RECEIVED]
    - [TASK SUMMARY]
